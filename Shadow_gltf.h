...
//	std::string filename;
//public:
//	Shadow_gltf(ID3D11Device* device, const std::string& filename, bool cereal = true);
//	virtual ~Shadow_gltf() = default;
//	struct scene
//	{
//		std::string name;
...
//
//	buffer_view Shadow_gltf::make_buffer_view(const tinygltf::Accessor& accessor);
//
//	//meshes 読み込み
