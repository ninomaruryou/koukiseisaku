...
void Shadow::clear(ID3D11DeviceContext* immediate_context, float depth)
{
	immediate_context->ClearDepthStencilView(depth_stencil_view.Get(), D3D11_CLEAR_DEPTH, depth, 0);
}
void Shadow::activate(ID3D11DeviceContext* immediate_context)
{
...
void Shadow::deactivate(ID3D11DeviceContext* immediate_context)
{
