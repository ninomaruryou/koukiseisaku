...
//		//D3D11_TEXTURE_ADDRESS_WRAP = ループする
//		//D3D11_TEXTURE_ADDRESS_MIRROR = ループする　一回回転する度反転する
//		//D3D11_TEXTURE_ADDRESS_CLAMP = ループしない
//		//D3D11_TEXTURE_ADDRESS_BORDER = ループしないスクロール仕切った部分は塗りつぶされる
//		//D3D11_TEXTURE_ADDRESS_MIRROR_ONCE = ループしない一回反転する
//		desc.AddressU = D3D11_TEXTURE_ADDRESS_CLAMP;//u座標 (x座標)
//		desc.AddressV = D3D11_TEXTURE_ADDRESS_CLAMP;//v座標 (y座標)
//		desc.AddressW = D3D11_TEXTURE_ADDRESS_CLAMP;//w座標 (透明度)
